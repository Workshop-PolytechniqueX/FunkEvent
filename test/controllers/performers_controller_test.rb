...
class PerformersControllerTest < ActionController::TestCase
  ...
  test "should create performer" do
    assert_difference('Performer.count') do
      post :create, performer: { description: @performer.description, genre: @performer.genre, name: @performer.name, type: @performer.type, url: @performer.url }
    end
  ...
  test "should update performer" do
    patch :update, id: @performer, performer: { description: @performer.description, genre: @performer.genre, name: @performer.name, type: @performer.type, url: @performer.url }
    assert_redirected_to performer_path(assigns(:performer))
  end
